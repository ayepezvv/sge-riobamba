...
new_models = """from sqlalchemy import Column, Integer, String, ForeignKey, DateTime, Text, Boolean, Float
...
"""
# Remove old imports and add the new one with classes
content = content.replace("from sqlalchemy import Column, Integer, String, ForeignKey, DateTime, Text, Boolean\nfrom sqlalchemy.dialects.postgresql import JSONB\nfrom sqlalchemy.orm import relationship\nfrom sqlalchemy.sql import func\nfrom app.db.base_class import Base\nfrom app.models.mixins import AuditMixin\n", new_models)

# Add ProcesoContratacion relation
