...
ALTER TABLE IF EXISTS ONLY contratacion.tipo_proceso DROP CONSTRAINT IF EXISTS tipo_proceso_creado_por_id_fkey;
ALTER TABLE IF EXISTS ONLY contratacion.tipo_proceso DROP CONSTRAINT IF EXISTS tipo_proceso_actualizado_por_id_fkey;
ALTER TABLE IF EXISTS ONLY contratacion.proceso_contratacion DROP CONSTRAINT IF EXISTS proceso_contratacion_usuario_id_fkey;
ALTER TABLE IF EXISTS ONLY contratacion.proceso_contratacion DROP CONSTRAINT IF EXISTS proceso_contratacion_tipo_proceso_id_fkey;
ALTER TABLE IF EXISTS ONLY contratacion.proceso_contratacion DROP CONSTRAINT IF EXISTS proceso_contratacion_creado_por_id_fkey;
ALTER TABLE IF EXISTS ONLY contratacion.proceso_contratacion DROP CONSTRAINT IF EXISTS proceso_contratacion_actualizado_por_id_fkey;
ALTER TABLE IF EXISTS ONLY contratacion.plantilla_documento DROP CONSTRAINT IF EXISTS plantilla_documento_tipo_proceso_id_fkey;
ALTER TABLE IF EXISTS ONLY contratacion.plantilla_documento DROP CONSTRAINT IF EXISTS plantilla_documento_creado_por_id_fkey;
ALTER TABLE IF EXISTS ONLY contratacion.plantilla_documento DROP CONSTRAINT IF EXISTS plantilla_documento_actualizado_por_id_fkey;
ALTER TABLE IF EXISTS ONLY contratacion.documento_generado DROP CONSTRAINT IF EXISTS documento_generado_proceso_contratacion_id_fkey;
ALTER TABLE IF EXISTS ONLY contratacion.documento_generado DROP CONSTRAINT IF EXISTS documento_generado_plantilla_id_fkey;
ALTER TABLE IF EXISTS ONLY contratacion.documento_generado DROP CONSTRAINT IF EXISTS documento_generado_creado_por_id_fkey;
ALTER TABLE IF EXISTS ONLY contratacion.documento_generado DROP CONSTRAINT IF EXISTS documento_generado_actualizado_por_id_fkey;
...
DROP INDEX IF EXISTS contratacion.ix_contratacion_tipo_proceso_id;
DROP INDEX IF EXISTS contratacion.ix_contratacion_proceso_contratacion_id;
DROP INDEX IF EXISTS contratacion.ix_contratacion_proceso_contratacion_codigo_proceso;
DROP INDEX IF EXISTS contratacion.ix_contratacion_plantilla_documento_id;
DROP INDEX IF EXISTS contratacion.ix_contratacion_documento_generado_id;
...
ALTER TABLE IF EXISTS ONLY contratacion.tipo_proceso DROP CONSTRAINT IF EXISTS tipo_proceso_pkey;
ALTER TABLE IF EXISTS ONLY contratacion.proceso_contratacion DROP CONSTRAINT IF EXISTS proceso_contratacion_pkey;
ALTER TABLE IF EXISTS ONLY contratacion.plantilla_documento DROP CONSTRAINT IF EXISTS plantilla_documento_pkey;
ALTER TABLE IF EXISTS ONLY contratacion.documento_generado DROP CONSTRAINT IF EXISTS documento_generado_pkey;
...
ALTER TABLE IF EXISTS contratacion.tipo_proceso ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS contratacion.proceso_contratacion ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS contratacion.plantilla_documento ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS contratacion.documento_generado ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE IF EXISTS contratacion.tipo_proceso_id_seq;
DROP TABLE IF EXISTS contratacion.tipo_proceso;
DROP SEQUENCE IF EXISTS contratacion.proceso_contratacion_id_seq;
DROP TABLE IF EXISTS contratacion.proceso_contratacion;
DROP SEQUENCE IF EXISTS contratacion.plantilla_documento_id_seq;
DROP TABLE IF EXISTS contratacion.plantilla_documento;
DROP SEQUENCE IF EXISTS contratacion.documento_generado_id_seq;
DROP TABLE IF EXISTS contratacion.documento_generado;
...
DROP SCHEMA IF EXISTS contratacion;
...
--
-- Name: contratacion; Type: SCHEMA; Schema: -; Owner: sge_admin
--

CREATE SCHEMA contratacion;


ALTER SCHEMA contratacion OWNER TO sge_admin;
...
--
-- Name: documento_generado; Type: TABLE; Schema: contratacion; Owner: sge_admin
--

CREATE TABLE contratacion.documento_generado (
    id integer NOT NULL,
    proceso_contratacion_id integer,
    plantilla_id integer,
    version integer NOT NULL,
    datos_json jsonb NOT NULL,
    ruta_archivo_generado character varying(255) NOT NULL,
...
ALTER TABLE contratacion.documento_generado OWNER TO sge_admin;

--
-- Name: documento_generado_id_seq; Type: SEQUENCE; Schema: contratacion; Owner: sge_admin
--

CREATE SEQUENCE contratacion.documento_generado_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE contratacion.documento_generado_id_seq OWNER TO sge_admin;

--
-- Name: documento_generado_id_seq; Type: SEQUENCE OWNED BY; Schema: contratacion; Owner: sge_admin
--

ALTER SEQUENCE contratacion.documento_generado_id_seq OWNED BY contratacion.documento_generado.id;


--
-- Name: plantilla_documento; Type: TABLE; Schema: contratacion; Owner: sge_admin
--

CREATE TABLE contratacion.plantilla_documento (
    id integer NOT NULL,
    nombre character varying(100) NOT NULL,
    ruta_archivo_docx character varying(255) NOT NULL,
...
ALTER TABLE contratacion.plantilla_documento OWNER TO sge_admin;

--
-- Name: plantilla_documento_id_seq; Type: SEQUENCE; Schema: contratacion; Owner: sge_admin
--

CREATE SEQUENCE contratacion.plantilla_documento_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE contratacion.plantilla_documento_id_seq OWNER TO sge_admin;

--
-- Name: plantilla_documento_id_seq; Type: SEQUENCE OWNED BY; Schema: contratacion; Owner: sge_admin
--

ALTER SEQUENCE contratacion.plantilla_documento_id_seq OWNED BY contratacion.plantilla_documento.id;


--
-- Name: proceso_contratacion; Type: TABLE; Schema: contratacion; Owner: sge_admin
--

CREATE TABLE contratacion.proceso_contratacion (
    id integer NOT NULL,
    codigo_proceso character varying(50) NOT NULL,
...
ALTER TABLE contratacion.proceso_contratacion OWNER TO sge_admin;

--
-- Name: proceso_contratacion_id_seq; Type: SEQUENCE; Schema: contratacion; Owner: sge_admin
--

CREATE SEQUENCE contratacion.proceso_contratacion_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE contratacion.proceso_contratacion_id_seq OWNER TO sge_admin;

--
-- Name: proceso_contratacion_id_seq; Type: SEQUENCE OWNED BY; Schema: contratacion; Owner: sge_admin
--

ALTER SEQUENCE contratacion.proceso_contratacion_id_seq OWNED BY contratacion.proceso_contratacion.id;


--
-- Name: tipo_proceso; Type: TABLE; Schema: contratacion; Owner: sge_admin
--

CREATE TABLE contratacion.tipo_proceso (
    id integer NOT NULL,
    nombre character varying(100) NOT NULL,
    creado_en timestamp with time zone DEFAULT now() NOT NULL,
    actualizado_en timestamp with time zone DEFAULT now() NOT NULL,
    creado_por_id integer,
    actualizado_por_id integer,
    categoria character varying(50) DEFAULT 'Bienes y Servicios'::character varying NOT NULL,
    condicion_monto character varying(255),
    is_activo boolean DEFAULT true NOT NULL
);


ALTER TABLE contratacion.tipo_proceso OWNER TO sge_admin;

--
-- Name: tipo_proceso_id_seq; Type: SEQUENCE; Schema: contratacion; Owner: sge_admin
--

CREATE SEQUENCE contratacion.tipo_proceso_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE contratacion.tipo_proceso_id_seq OWNER TO sge_admin;

--
-- Name: tipo_proceso_id_seq; Type: SEQUENCE OWNED BY; Schema: contratacion; Owner: sge_admin
--

ALTER SEQUENCE contratacion.tipo_proceso_id_seq OWNED BY contratacion.tipo_proceso.id;
...
--
-- Name: documento_generado id; Type: DEFAULT; Schema: contratacion; Owner: sge_admin
--

ALTER TABLE ONLY contratacion.documento_generado ALTER COLUMN id SET DEFAULT nextval('contratacion.documento_generado_id_seq'::regclass);


--
-- Name: plantilla_documento id; Type: DEFAULT; Schema: contratacion; Owner: sge_admin
--

ALTER TABLE ONLY contratacion.plantilla_documento ALTER COLUMN id SET DEFAULT nextval('contratacion.plantilla_documento_id_seq'::regclass);


--
-- Name: proceso_contratacion id; Type: DEFAULT; Schema: contratacion; Owner: sge_admin
--

ALTER TABLE ONLY contratacion.proceso_contratacion ALTER COLUMN id SET DEFAULT nextval('contratacion.proceso_contratacion_id_seq'::regclass);


--
-- Name: tipo_proceso id; Type: DEFAULT; Schema: contratacion; Owner: sge_admin
--

ALTER TABLE ONLY contratacion.tipo_proceso ALTER COLUMN id SET DEFAULT nextval('contratacion.tipo_proceso_id_seq'::regclass);
...
--
-- Data for Name: documento_generado; Type: TABLE DATA; Schema: contratacion; Owner: sge_admin
--

COPY contratacion.documento_generado (id, proceso_contratacion_id, plantilla_id, version, datos_json, ruta_archivo_generado, fecha_generacion, creado_en, actualizado_en, creado_por_id, actualizado_por_id) FROM stdin;
\.


--
-- Data for Name: plantilla_documento; Type: TABLE DATA; Schema: contratacion; Owner: sge_admin
--

COPY contratacion.plantilla_documento (id, nombre, ruta_archivo_docx, tipo_proceso_id, creado_en, actualizado_en, creado_por_id, actualizado_por_id, anio, version, is_activa) FROM stdin;
1	TDR Estandar	templates/contratacion/dummy_template.docx	1	2026-03-08 02:56:29.611518+00	2026-03-08 02:56:29.611518+00	\N	\N	2026	1	t
2	1 Formulario Certificación de Catálogo Electrónico	templates/contratacion/8_1_Formulario_Certificación_de_Catálogo_Electrónico_v1_1772944259.docx	8	2026-03-08 04:30:59.557867+00	2026-03-08 04:30:59.557867+00	1	\N	2026	1	t
3	4 Formulario Términos de Referencia	templates/contratacion/8_4_Formulario_Términos_de_Referencia_v1_1772944330.docx	8	2026-03-08 04:32:10.54913+00	2026-03-08 04:32:10.54913+00	1	\N	2026	1	t
\.


--
-- Data for Name: proceso_contratacion; Type: TABLE DATA; Schema: contratacion; Owner: sge_admin
--

COPY contratacion.proceso_contratacion (id, codigo_proceso, nombre_proyecto, descripcion, fecha_creacion, usuario_id, creado_en, actualizado_en, creado_por_id, actualizado_por_id, tipo_proceso_id) FROM stdin;
1	001	Instalacion de fibra optica	Instalacion de fibra optica	2026-03-08 03:03:55.993321+00	1	2026-03-08 03:03:55.993321+00	2026-03-08 03:03:55.993321+00	\N	\N	\N
2	2026-GG-TI-005	ADQUISICION DE PANTALLAS INTERACTIVAS INTELIGENTES PARA LA EMPRESA PUBLICA RIOBAMBA RIOBAMBA EP	[Ínfima Cuantía] ADQUISICION DE PANTALLAS INTERACTIVAS INTELIGENTES PARA LA EMPRESA PUBLICA RIOBAMBA RIOBAMBA EP	2026-03-08 05:03:49.716077+00	1	2026-03-08 05:03:49.716077+00	2026-03-08 05:03:49.716077+00	\N	\N	8
\.


--
-- Data for Name: tipo_proceso; Type: TABLE DATA; Schema: contratacion; Owner: sge_admin
--

COPY contratacion.tipo_proceso (id, nombre, creado_en, actualizado_en, creado_por_id, actualizado_por_id, categoria, condicion_monto, is_activo) FROM stdin;
2	Catálogo Electrónico	2026-03-08 03:38:50.462581+00	2026-03-08 03:38:50.462581+00	1	\N	Bienes y Servicios	Sin limite de monto	t
1	Subasta Inversa Electronica	2026-03-08 02:56:29.599608+00	2026-03-08 03:41:51.066381+00	\N	1	Bienes y Servicios	Mayor a $ 10.000,00	t
3	Licitación	2026-03-08 03:40:55.814994+00	2026-03-08 03:41:57.242441+00	1	1	Bienes y Servicios	Mayor a $ 10.000,00	t
5	Licitación	2026-03-08 03:42:22.367579+00	2026-03-08 03:42:22.367579+00	1	\N	Obras	Mayor a $10.000,00	t
7	Concurso Público	2026-03-08 03:43:17.350223+00	2026-03-08 03:43:17.350223+00	1	\N	Consultoría	Mayor a $ 10.000,00	t
8	Ínfima Cuantía	2026-03-08 03:45:19.109763+00	2026-03-08 03:55:17.108023+00	1	1	Bienes y Servicios	Menor o igual a $ 10.000,00	t
4	Ínfima Cuantía	2026-03-08 03:41:42.178917+00	2026-03-08 03:55:29.212801+00	1	1	Obras	Menor o igual a $ 10.000,00	t
6	Ínfima Cuantía	2026-03-08 03:42:53.703194+00	2026-03-08 03:55:36.738764+00	1	1	Consultoría	Menor o igual a $ 10.000,00	t
\.
...
--
-- Name: documento_generado_id_seq; Type: SEQUENCE SET; Schema: contratacion; Owner: sge_admin
--

SELECT pg_catalog.setval('contratacion.documento_generado_id_seq', 1, false);


--
-- Name: plantilla_documento_id_seq; Type: SEQUENCE SET; Schema: contratacion; Owner: sge_admin
--

SELECT pg_catalog.setval('contratacion.plantilla_documento_id_seq', 3, true);


--
-- Name: proceso_contratacion_id_seq; Type: SEQUENCE SET; Schema: contratacion; Owner: sge_admin
--

SELECT pg_catalog.setval('contratacion.proceso_contratacion_id_seq', 2, true);


--
-- Name: tipo_proceso_id_seq; Type: SEQUENCE SET; Schema: contratacion; Owner: sge_admin
--

SELECT pg_catalog.setval('contratacion.tipo_proceso_id_seq', 10, true);
...
--
-- Name: documento_generado documento_generado_pkey; Type: CONSTRAINT; Schema: contratacion; Owner: sge_admin
--

ALTER TABLE ONLY contratacion.documento_generado
    ADD CONSTRAINT documento_generado_pkey PRIMARY KEY (id);


--
-- Name: plantilla_documento plantilla_documento_pkey; Type: CONSTRAINT; Schema: contratacion; Owner: sge_admin
--

ALTER TABLE ONLY contratacion.plantilla_documento
    ADD CONSTRAINT plantilla_documento_pkey PRIMARY KEY (id);


--
-- Name: proceso_contratacion proceso_contratacion_pkey; Type: CONSTRAINT; Schema: contratacion; Owner: sge_admin
--

ALTER TABLE ONLY contratacion.proceso_contratacion
    ADD CONSTRAINT proceso_contratacion_pkey PRIMARY KEY (id);


--
-- Name: tipo_proceso tipo_proceso_pkey; Type: CONSTRAINT; Schema: contratacion; Owner: sge_admin
--

ALTER TABLE ONLY contratacion.tipo_proceso
...
--
-- Name: ix_contratacion_documento_generado_id; Type: INDEX; Schema: contratacion; Owner: sge_admin
--

CREATE INDEX ix_contratacion_documento_generado_id ON contratacion.documento_generado USING btree (id);


--
-- Name: ix_contratacion_plantilla_documento_id; Type: INDEX; Schema: contratacion; Owner: sge_admin
--

CREATE INDEX ix_contratacion_plantilla_documento_id ON contratacion.plantilla_documento USING btree (id);


--
-- Name: ix_contratacion_proceso_contratacion_codigo_proceso; Type: INDEX; Schema: contratacion; Owner: sge_admin
--

CREATE UNIQUE INDEX ix_contratacion_proceso_contratacion_codigo_proceso ON contratacion.proceso_contratacion USING btree (codigo_proceso);


--
-- Name: ix_contratacion_proceso_contratacion_id; Type: INDEX; Schema: contratacion; Owner: sge_admin
--

CREATE INDEX ix_contratacion_proceso_contratacion_id ON contratacion.proceso_contratacion USING btree (id);


--
-- Name: ix_contratacion_tipo_proceso_id; Type: INDEX; Schema: contratacion; Owner: sge_admin
--

CREATE INDEX ix_contratacion_tipo_proceso_id ON contratacion.tipo_proceso USING btree (id);
...
--
-- Name: documento_generado documento_generado_actualizado_por_id_fkey; Type: FK CONSTRAINT; Schema: contratacion; Owner: sge_admin
--

ALTER TABLE ONLY contratacion.documento_generado
    ADD CONSTRAINT documento_generado_actualizado_por_id_fkey FOREIGN KEY (actualizado_por_id) REFERENCES administracion.users(id) ON DELETE SET NULL;


--
-- Name: documento_generado documento_generado_creado_por_id_fkey; Type: FK CONSTRAINT; Schema: contratacion; Owner: sge_admin
--

ALTER TABLE ONLY contratacion.documento_generado
    ADD CONSTRAINT documento_generado_creado_por_id_fkey FOREIGN KEY (creado_por_id) REFERENCES administracion.users(id) ON DELETE SET NULL;


--
-- Name: documento_generado documento_generado_plantilla_id_fkey; Type: FK CONSTRAINT; Schema: contratacion; Owner: sge_admin
--

ALTER TABLE ONLY contratacion.documento_generado
    ADD CONSTRAINT documento_generado_plantilla_id_fkey FOREIGN KEY (plantilla_id) REFERENCES contratacion.plantilla_documento(id) ON DELETE RESTRICT;


--
-- Name: documento_generado documento_generado_proceso_contratacion_id_fkey; Type: FK CONSTRAINT; Schema: contratacion; Owner: sge_admin
--

ALTER TABLE ONLY contratacion.documento_generado
    ADD CONSTRAINT documento_generado_proceso_contratacion_id_fkey FOREIGN KEY (proceso_contratacion_id) REFERENCES contratacion.proceso_contratacion(id) ON DELETE CASCADE;


--
-- Name: plantilla_documento plantilla_documento_actualizado_por_id_fkey; Type: FK CONSTRAINT; Schema: contratacion; Owner: sge_admin
--

ALTER TABLE ONLY contratacion.plantilla_documento
    ADD CONSTRAINT plantilla_documento_actualizado_por_id_fkey FOREIGN KEY (actualizado_por_id) REFERENCES administracion.users(id) ON DELETE SET NULL;


--
-- Name: plantilla_documento plantilla_documento_creado_por_id_fkey; Type: FK CONSTRAINT; Schema: contratacion; Owner: sge_admin
--

ALTER TABLE ONLY contratacion.plantilla_documento
    ADD CONSTRAINT plantilla_documento_creado_por_id_fkey FOREIGN KEY (creado_por_id) REFERENCES administracion.users(id) ON DELETE SET NULL;


--
-- Name: plantilla_documento plantilla_documento_tipo_proceso_id_fkey; Type: FK CONSTRAINT; Schema: contratacion; Owner: sge_admin
--

ALTER TABLE ONLY contratacion.plantilla_documento
    ADD CONSTRAINT plantilla_documento_tipo_proceso_id_fkey FOREIGN KEY (tipo_proceso_id) REFERENCES contratacion.tipo_proceso(id);


--
-- Name: proceso_contratacion proceso_contratacion_actualizado_por_id_fkey; Type: FK CONSTRAINT; Schema: contratacion; Owner: sge_admin
--

ALTER TABLE ONLY contratacion.proceso_contratacion
    ADD CONSTRAINT proceso_contratacion_actualizado_por_id_fkey FOREIGN KEY (actualizado_por_id) REFERENCES administracion.users(id) ON DELETE SET NULL;


--
-- Name: proceso_contratacion proceso_contratacion_creado_por_id_fkey; Type: FK CONSTRAINT; Schema: contratacion; Owner: sge_admin
--

ALTER TABLE ONLY contratacion.proceso_contratacion
    ADD CONSTRAINT proceso_contratacion_creado_por_id_fkey FOREIGN KEY (creado_por_id) REFERENCES administracion.users(id) ON DELETE SET NULL;


--
-- Name: proceso_contratacion proceso_contratacion_tipo_proceso_id_fkey; Type: FK CONSTRAINT; Schema: contratacion; Owner: sge_admin
--

ALTER TABLE ONLY contratacion.proceso_contratacion
    ADD CONSTRAINT proceso_contratacion_tipo_proceso_id_fkey FOREIGN KEY (tipo_proceso_id) REFERENCES contratacion.tipo_proceso(id) ON DELETE RESTRICT;


--
-- Name: proceso_contratacion proceso_contratacion_usuario_id_fkey; Type: FK CONSTRAINT; Schema: contratacion; Owner: sge_admin
--

ALTER TABLE ONLY contratacion.proceso_contratacion
    ADD CONSTRAINT proceso_contratacion_usuario_id_fkey FOREIGN KEY (usuario_id) REFERENCES administracion.users(id) ON DELETE RESTRICT;


--
-- Name: tipo_proceso tipo_proceso_actualizado_por_id_fkey; Type: FK CONSTRAINT; Schema: contratacion; Owner: sge_admin
--

ALTER TABLE ONLY contratacion.tipo_proceso
    ADD CONSTRAINT tipo_proceso_actualizado_por_id_fkey FOREIGN KEY (actualizado_por_id) REFERENCES administracion.users(id) ON DELETE SET NULL;


--
-- Name: tipo_proceso tipo_proceso_creado_por_id_fkey; Type: FK CONSTRAINT; Schema: contratacion; Owner: sge_admin
--

ALTER TABLE ONLY contratacion.tipo_proceso
    ADD CONSTRAINT tipo_proceso_creado_por_id_fkey FOREIGN KEY (creado_por_id) REFERENCES administracion.users(id) ON DELETE SET NULL;
