              ...
              <Grid>
                <Box sx={{ position: 'relative' }}>
                  <Avatar color="primary">
                    <NotificationsNoneOutlinedIcon style={{ color: theme.vars.palette.common.white }} />
                  </Avatar>
                </Box>
              </Grid>
              <Grid size="grow">
          ...
          <Grid size={12}>
            <Grid container spacing={2} sx={{ alignItems: 'center', justifyContent: 'center' }}>
              <Grid>
                <Box sx={{ position: 'relative' }}>
                  <Avatar color="error">
                    <ShoppingCartOutlinedIcon style={{ color: theme.vars.palette.common.white }} />
                  </Avatar>
                </Box>
              </Grid>
              <Grid size="grow">
              ...
              <Grid>
                <Box sx={{ position: 'relative' }}>
                  <Avatar color="success">
                    <DescriptionOutlinedIcon style={{ color: theme.vars.palette.common.white }} />
                  </Avatar>
                </Box>
              </Grid>
              <Grid size="grow">
