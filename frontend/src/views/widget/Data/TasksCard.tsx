            ...
            <Grid container spacing={2}>
              <Grid>
                <Avatar color="success" size="sm" sx={{ top: 10 }}>
                  <ThumbUpAltOutlinedIcon style={{ color: theme.vars.palette.common.white }} />
                </Avatar>
              </Grid>
              <Grid size="grow">
            ...
            <Grid container spacing={2}>
              <Grid>
                <Avatar color="primary" size="sm" sx={{ top: 10 }}>
                  <QueryBuilderOutlinedIcon style={{ color: theme.vars.palette.common.white }} />
                </Avatar>
              </Grid>
              <Grid size="grow">
                <Grid container spacing={0}>
            ...
            <Grid container spacing={2}>
              <Grid>
                <Avatar color="error" size="sm" sx={{ top: 10 }}>
                  <BugReportOutlinedIcon style={{ color: theme.vars.palette.common.white }} />
                </Avatar>
              </Grid>
              <Grid size="grow">
                <Grid container spacing={0}>
            ...
            <Grid container spacing={2}>
              <Grid>
                <Avatar color="warning" size="sm" sx={{ top: 10 }}>
                  <ErrorOutlineOutlinedIcon style={{ color: theme.vars.palette.common.white }} />
                </Avatar>
              </Grid>
              <Grid size="grow">
                <Grid container spacing={0}>
