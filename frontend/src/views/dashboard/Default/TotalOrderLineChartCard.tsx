...
export default function TotalOrderLineChartCard({ isLoading }: TotalOrderLineChartCardProps) {
  ...
  const handleChangeTime = (_event: React.MouseEvent<HTMLButtonElement, MouseEvent>, newValue: boolean) => {
          ...
          sx={{
            ...
            '&:after': {
              ...
              ...theme.applyStyles('dark', {
                background: `linear-gradient(210.04deg, ${theme.vars.palette.primary.dark} -50.94%, rgba(144, 202, 249, 0) 95.49%)`
              }),
              borderRadius: '50%',
              top: { xs: -85 },
              right: { xs: -95 }
            ...
            '&:before': {
              ...
              background: theme.vars.palette.primary[800],
              ...theme.applyStyles('dark', {
                background: `linear-gradient(140.9deg, ${theme.vars.palette.primary.dark} -14.02%, rgba(144, 202, 249, 0) 85.50%)`
              }),
              borderRadius: '50%',
              top: { xs: -125 },
              right: { xs: -15 },
