...
export default function AskConfirmationBeforeSave() {
  ...
  const handleYes = async () => {
    ...
    try {
      ...
      dispatch(openSnackbar({ open: true, message: 'User Successfully Saved', variant: 'alert', alert: { color: 'success' } }));
      resolve(response);
      setPromiseArguments(null);
    } catch {
      dispatch(
...
const columns: GridColDef[] = [
  ...
  { field: 'age', headerName: 'Age', flex: 0.5, type: 'number', editable: true, align: 'left', minWidth: 120, headerAlign: 'left' },
  { field: 'dateCreated', headerName: 'Date Created', type: 'date', flex: 0.75, minWidth: 180 },
  { field: 'lastLogin', headerName: 'Last Login', type: 'dateTime', flex: 0.75, minWidth: 220 }
];

const rows: GridRowsProp = [
  { id: 1, name: randomTraderName(), age: 25, dateCreated: randomCreatedDate(), lastLogin: randomUpdatedDate() },
  { id: 2, name: randomTraderName(), age: 36, dateCreated: randomCreatedDate(), lastLogin: randomUpdatedDate() },
  { id: 3, name: randomTraderName(), age: 19, dateCreated: randomCreatedDate(), lastLogin: randomUpdatedDate() },
  { id: 4, name: randomTraderName(), age: 28, dateCreated: randomCreatedDate(), lastLogin: randomUpdatedDate() },
  { id: 5, name: randomTraderName(), age: 23, dateCreated: randomCreatedDate(), lastLogin: randomUpdatedDate() }
];
