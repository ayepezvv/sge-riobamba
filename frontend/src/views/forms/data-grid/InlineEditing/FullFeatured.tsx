...
export default function FullFeaturedCrudGrid() {
  ...
  const columns: GridColDef[] = [
    ...
    { flex: 0.5, field: 'age', headerName: 'Age', type: 'number', minWidth: 124, align: 'left', headerAlign: 'left', editable: true },
    { field: 'joinDate', headerName: 'Join date', type: 'date', flex: 0.75, minWidth: 180, editable: true },
    {
      field: 'role',
    ...
    >
      <Box
        sx={{
          ...
          ...dataGridStyles,
          '& .MuiDataGrid-root': {
            '& .MuiDataGrid-cell--editing': { '& .MuiInputBase-root': { width: 150, '& .MuiSelect-select': { pt: 0.75, pb: 0.75 } } },
            '& .MuiDataGrid-row--editing': { boxShadow: 'none' }
          }
        }}
      >
        <DataGrid
