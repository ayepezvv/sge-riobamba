...
const columns = [
  { field: 'name', headerName: 'Name', flex: 0.75, minWidth: 120 },
  { field: 'role', headerName: 'Role', renderEditCell: renderSelectEditInputCell, editable: true, flex: 1, minWidth: 180 }
];

const rows = [
  { id: 1, name: 'Olivier', role: 'Back-end Developer' },
  { id: 2, name: 'Danail', role: 'UX Designer' },
  { id: 3, name: 'Matheus', role: 'Front-end Developer' }
];
