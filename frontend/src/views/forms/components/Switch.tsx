            ...
            <Grid container spacing={2}>
              ...
              <Grid>
                <Switch
                  ...
                  sx={{
                    color: 'warning.dark',
                    '& .Mui-checked': { color: `${theme.vars.palette.warning.dark} !important` },
                    '& .Mui-checked+.MuiSwitch-track': { bgcolor: `${theme.vars.palette.warning.main} !important` }
                  }}
                />
              </Grid>
              <Grid>
                <Switch
                  ...
                  sx={{
                    color: 'success.dark',
                    '& .Mui-checked': { color: `${theme.vars.palette.success.dark} !important` },
                    '& .Mui-checked+.MuiSwitch-track': { bgcolor: `${theme.vars.palette.success.light} !important` }
                  }}
                />
              </Grid>
              <Grid>
                <Switch
                  ...
                  sx={{
                    color: 'error.main',
                    '& .Mui-checked': { color: `${theme.vars.palette.error.main} !important` },
                    '& .Mui-checked+.MuiSwitch-track': { bgcolor: `${theme.vars.palette.error.light} !important` }
                  }}
                />
              </Grid>
              <Grid>
              ...
              <Grid>
                <Switch
                  ...
                  sx={{
                    color: 'orange.main',
                    '& .Mui-checked': { color: `${theme.vars.palette.orange.main} !important` },
                    '& .Mui-checked+.MuiSwitch-track': { bgcolor: `${theme.vars.palette.orange.light} !important` }
                  }}
                />
              </Grid>
              <Grid>
                <Switch
                  ...
                  sx={{
                    color: 'dark.900',
                    '& .Mui-checked': { color: `${theme.vars.palette.dark[900]} !important` },
                    '& .Mui-checked+.MuiSwitch-track': { bgcolor: `${theme.vars.palette.dark.light} !important` }
                  }}
                />
              </Grid>
            </Grid>
