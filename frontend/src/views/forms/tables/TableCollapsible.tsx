          ...
          <Collapse in={open} timeout="auto" unmountOnExit>
            {open && (
              <Box sx={{ margin: 1 }}>
                <TableContainer>
                  <SubCard
                    sx={{ bgcolor: 'grey.50', ...theme.applyStyles('dark', { bgcolor: 'dark.800' }), mb: 2 }}
                    title="History"
                    content={false}
                    secondary={
                      <CSVExport data={row.history?.map((historyRow: any) => historyRow)} filename={'collapse-table.csv'} header={header} />
                    }
                  >
