  ...
  return (
    <>
      <Grid container spacing={{ xs: 3, md: 1 }}>
        ...
        <Grid size={12}>
          {data.length ? (
            <MainCard content={false} sx={{ bgcolor: 'grey.50', ...theme.applyStyles('dark', { bgcolor: 'dark.800' }) }}>
              {/* table */}
              <TableContainer>
                <Table
                    ...
                    {data.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row, index) => {
                      ...
                      return (
                        <TableRow
                          hover
                          sx={{
                            bgcolor: !row.isRead ? 'grey.100' : 'transparent',
                            ...theme.applyStyles('dark', { bgcolor: !row.isRead ? 'dark.main' : 'transparent' }),
                            '& td:last-of-type>div': {
                              position: 'absolute',
                              top: '50%',
                              right: 5,
