...
export default function MailDetails({ handleUserDetails, data, handleStarredChange, handleImportantChange }: MailDetailsProps) {
  ...
  return (
    <MainCard sx={{ bgcolor: 'grey.50', ...theme.applyStyles('dark', { bgcolor: 'dark.main' }) }} content={false}>
      <CardContent>
        <Grid container spacing={gridSpacing}>
          <Grid size={12}>
            <Grid container spacing={{ xs: 1, md: 0 }} sx={{ alignItems: 'center', justifyContent: 'space-between' }}>
              <Grid>
                <Stack direction="row" sx={{ alignItems: 'center', gap: { xs: 1, md: 2 } }}>
                  ...
                  <Grid container sx={{ alignItems: 'center' }}>
                    <Grid size={12}>
                      <Stack
                        ...
                        sx={{ alignItems: { xs: 'flex-start', md: 'center' }, sx: { gap: { xs: 0, md: 1 } } }}
                      >
            ...
            <Grid container spacing={gridSpacing}>
              ...
              {openQuill && (
                <Grid size={12}>
                  <SubCard
                    sx={{
                      bgcolor: withAlpha(theme.vars.palette.primary[200], 0.4),
