    ...
    <TableContainer>
      <Table
        sx={{
          ...
          '& td:last-of-type': { pr: 0, minWidth: 260 },
          '& tbody tr:last-of-type  td': { borderBottom: 'none' },
          [theme.breakpoints.down('xl')]: {
            '& tr:not(:last-of-type)': {
              borderBottom: '1px solid',
              borderBottomColor: 'rgba(224, 224, 224, 1)',
              ...theme.applyStyles('dark', { borderBottomColor: 'rgb(132, 146, 196, .2)' })
            },
            '& td': { display: 'inline-block', borderBottom: 'none', pl: 0 },
            '& td:first-of-type': { display: 'block' }
          }
        }}
      >
        <TableBody>
            ...
            <TableRow key={index}>
              ...
              <TableCell>
                <Grid container spacing={1}>
                  ...
                  <Grid size={12}>
                    <Grid container>
                      <AvatarGroup max={4} sx={{ '& .MuiAvatar-root': { width: 32, height: 32, fontSize: '1rem' } }}>
