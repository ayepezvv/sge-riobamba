...
export default function ProductInfo({ product }: { product: Products }) {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      dispatch(openSnackbar({ open: true, message: 'Submit Success', variant: 'alert', alert: { color: 'success' }, close: false }));
  ...
  const addCart = () => {
    ...
    dispatch(addProduct(values, cart.checkout.products));
    dispatch(openSnackbar({ open: true, message: 'Add To Cart Success', variant: 'alert', alert: { color: 'success' }, close: false }));
  };
                    ...
                    <TableRow>
                      <TableCell>
                        <Stack>
                          ...
                          <Typography variant="caption" component={Link} href="#" sx={{ color: 'primary.main' }}>
                            Size Chart?
                          </Typography>
                        </Stack>
                      </TableCell>
