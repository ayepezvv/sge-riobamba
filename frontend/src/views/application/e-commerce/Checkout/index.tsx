...
export default function Checkout() {
  ...
  const updateQuantity = debounce((id: string | number | undefined, quantity: number) => {
        ...
        <Tabs
          ...
          sx={{
            ...
            '& .MuiButtonBase-root + .MuiButtonBase-root': {
              ...
              overflow: 'visible',
              ml: 2,
              '&:after': { content: '""', bgcolor: '#ccc', width: 1, height: 'calc(100% - 16px)', position: 'absolute', top: 8, left: -8 }
            }
          }}
        >
          {tabsOption.map((tab, index) => (
            <Tab
              ...
              sx={(theme) => ({
                ...
                '& > svg': { marginBottom: '0px !important', mr: 1.25, mt: 0.25, height: 20, width: 20 },
