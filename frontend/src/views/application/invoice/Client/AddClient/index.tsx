...
// tabs option
const tabsOption = [
  { label: 'Personal information', icon: <PersonAddTwoTone />, caption: 'Profile Settings' },
  { label: 'Contact detail', icon: <RecentActorsIcon />, caption: 'Contact Information' },
  { label: 'Address detail', icon: <PinDropTwoTone />, caption: 'Address detail' },
  { label: 'Other Detail', icon: <WorkTwoToneIcon />, caption: 'Update Profile Security' }
];
