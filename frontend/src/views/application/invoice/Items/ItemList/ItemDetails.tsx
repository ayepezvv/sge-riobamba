...
export default function ItemDetails({ rowValue, handleDrawerClose }: RowDetailProps) {
  ...
  return (
    <Grid container spacing={1.5}>
      <Grid size={12}>
        <Stack direction="row" sx={{ alignItems: 'center', justifyContent: 'space-between', px: 2.5, pt: 1.5, ml: '-10px', gap: 1 }}>
          ...
          <Stack sx={{ justifyContent: 'flex-end', gap: 1 }}>
        ...
        >
          <Stack direction="row" sx={{ alignItems: 'center', justifyContent: 'space-between', py: 1.5, px: 2.5, gap: 1 }}>
            <Stack direction={'row'} sx={{ gap: 1 }}>
              ...
              <Stack direction="row" sx={{ alignItems: 'center', width: { xs: '180px', sm: '218px', md: '251px' }, gap: 1 }}>
