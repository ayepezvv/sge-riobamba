...
const TechLight = '/assets/images/landing/berry_tech_light.svg';
const TechDark = '/assets/images/landing/berry_tech_dark.svg';
  ...
  const HeaderAnimationImagememo = useMemo(
    () => (
      <HeaderAnimationImage
        src={colorScheme === ThemeMode.DARK ? BgDark : BgLight}
        alt="Berry"
        sx={{
          ...
          <Grid container spacing={6}>
            ...
            <Grid sx={{ mt: -2.5, textAlign: { xs: 'center', md: 'left' } }} size={12}>
              ...
              >
                ...
                >
                  Berry is a React-based dashboard template that helps you build faster, more beautiful web applications.
                </Typography>
              </motion.div>
            </Grid>
            <Grid size={12}>
            ...
            <Grid size={12}>
              ...
              >
                <Stack direction="row" sx={{ alignItems: 'center', justifyContent: { xs: 'center', md: 'flex-start' } }}>
                  <CardMedia
                    component="img"
                    image={colorScheme === ThemeMode.DARK ? TechDark : TechLight}
                    alt="Berry Tech"
