          ...
          <Grid key={index} size={{ xs: 12, sm: 6, md: 4 }}>
            <MainCard
              ...
              sx={{
                ...
                borderColor: plan.active ? 'secondary.main' : withAlpha(theme.vars.palette.primary[200], 0.75),
                ...(!plan.active && theme.applyStyles('dark', { borderColor: 'background.default' }))
              }}
            >
                ...
                <Grid size={12}>
                  <List
                    sx={{
                      m: 0,
                      p: 0,
                      '&> li': { px: 0, py: 0.625, '& svg': { fill: theme.vars.palette.success.dark } }
                    }}
                    component="ul"
                  >
                    {planList.map((list, i) => (
