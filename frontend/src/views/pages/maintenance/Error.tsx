  ...
  return (
    <Stack sx={{ gap: gridSpacing, alignItems: 'center', justifyContent: 'center', minHeight: '100vh' }}>
      <Box sx={{ maxWidth: { xs: 350, sm: 580, md: 720 }, margin: '0 auto', position: 'relative' }}>
        <CardMedia component="img" image={colorScheme === ThemeMode.DARK ? imageDarkBackground : imageBackground} title="Slider5 image" />
        <CardMedia
          component="img"
          image={imageText}
      ...
      <Stack sx={{ justifyContent: 'center', alignItems: 'center', p: 1.5, maxWidth: 350, gap: gridSpacing }}>
