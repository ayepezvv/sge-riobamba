                  ...
                  <Grid container spacing={gridSpacing}>
                    <Grid size={{ sm: 'grow' }}>
                      <Typography align="left" variant="body2">
                        ...
                        <Typography variant="subtitle1" component={Link} href="#" sx={{ mx: 0.5, color: 'primary.main' }}>
                          Privacy Policy
                        </Typography>
                        and
                        <Typography variant="subtitle1" component={Link} href="#" sx={{ ml: 0.5, color: 'primary.main' }}>
                          Cookie Policy
                        </Typography>
                      </Typography>
                    </Grid>
